...
QT_MOC_LITERAL(1, 12, 16), // "sig_NeedGetLabel"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "getBack"
QT_MOC_LITERAL(4, 38, 14), // "QNetworkReply*"
QT_MOC_LITERAL(5, 53, 5) // "reply"

    },
    "mqttrequest\0sig_NeedGetLabel\0\0getBack\0"
...
void mqttrequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_NeedGetLabel(); break;
        ...
        {
            using _t = void (mqttrequest::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mqttrequest::sig_NeedGetLabel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mqttrequest::sig_NeedGetLabel()
{
